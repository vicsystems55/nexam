...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Flags Icons</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-life-buoy mr-2 fs-14"></i>Icons</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Flags Icons</a></li>
								</ol>
							</div>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">Flags Icons</h3>
									</div>
									<div class="card-body">
										<div class="row">
											<div class="col-lg-12 col-sm-12 mb-4">
												<p class="mb-2"> For more info <a href="" target="_blank">click here</a>.</p>
												<p><code>&lt;i class="flag flag-ICON_NAME"&gt;&lt;/i&gt;</code></p>
											</div>
											<div class="col-sm-12 col-lg-12">
												<div class="icons-list-wrap flags-icons">
													<ul class="icons-list">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">Payments Icons</h3>
									</div>
									<div class="card-body">
										<div class="row">
											<div class="col-lg-12 col-sm-12 mb-4">
											...
											<div class="col-sm-12 col-lg-12">
												<div class="icons-list-wrap payment-icons">
													<ul class="icons-list">
