...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Blog 03</h4>
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/' . $page='#')}}">Blog 03</a></li>
								</ol>
							</div>
								...
								<div class="card overflow-hidden">
									...
									<div class="card-body">
										<div class="item7-card-desc d-md-flex mb-5">
											<a href="{{url('/' . $page='#')}}" class="d-flex mr-4 mb-2"><i class="fe fe-calendar fs-16 mr-1"></i><div class="mt-0">Jan-18-2020</div></a>
											<a href="{{url('/' . $page='#')}}" class="d-flex mb-2"><i class="fe fe-user fs-16 mr-1"></i><div class="mt-0">Anna Ogden</div></a>
									...
									<div class="card-body">
										<div class="d-sm-flex mt-0 p-5 sub-review-section border border-bottom-0 br-bl-0 br-br-0">
											<div class="d-flex mr-3">
												<a href="{{url('/' . $page='#')}}"><img class="media-object brround avatar-md" alt="64x64" src="{{URL::asset('assets/images/users/1.jpg')}}"> </a>
											</div>
											<div class="media-body">
												...
												<a href="{{url('/' . $page='#')}}" class="mr-2 mt-1"><span class="badge badge-primary">Helpful</span></a>
												...
												<div class="btn-group btn-group-sm mb-1 ml-auto float-sm-right mt-1">
													<button class="btn btn-light" type="button"><i class="fe fe-thumbs-up  fs-16 text-icon"></i></button>
													<button class="btn btn-light" type="button"><i class="fe fe-thumbs-down  fs-16 text-icon"></i></button>
												</div>
											</div>
										</div>
										<div class="d-sm-flex p-5 sub-review-section border subsection-color br-tl-0 br-tr-0">
											<div class="d-flex mr-3">
												<a href="{{url('/' . $page='#')}}"><img class="media-object brround avatar-md" alt="64x64" src="{{URL::asset('assets/images/users/2.jpg')}}"> </a>
											</div>
											<div class="media-body">
										...
										<div class="d-sm-flex p-5 mt-4 border sub-review-section">
											<div class="d-flex mr-3">
												<a href="{{url('/' . $page='#')}}"><img class="media-object brround avatar-md" alt="64x64" src="{{URL::asset('assets/images/users/3.jpg')}}"> </a>
											</div>
											<div class="media-body">
