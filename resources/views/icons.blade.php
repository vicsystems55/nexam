...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Font Awesome Icons</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-life-buoy mr-2 fs-14"></i>Icons</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Font Awesome Icons</a></li>
								</ol>
							</div>
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-12 col-sm-12 mb-4">
												<p class="mb-2">Powered by Font Awesome set. For more info <a href="http://fontawesome.io" target="_blank">click here</a>.</p>
