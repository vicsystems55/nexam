									...
									<div class="panel-group" id="accordion1" role="tablist" aria-multiselectable="true">
										...
										<div class="panel panel-default mt-2">
											<div class="panel-heading" role="tab" id="heading4">
												<h4 class="panel-title">
													<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion1" href="#collapse4" aria-expanded="false" aria-controls="collapseThree3">
										...
										<div class="panel panel-default mt-2">
											<div class="panel-heading" role="tab" id="heading5">
												<h4 class="panel-title">
													<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion1" href="#collapse5" aria-expanded="false" aria-controls="collapseThree3">
										...
										<div class="panel panel-default mt-2">
											<div class="panel-heading" role="tab" id="heading6">
												<h4 class="panel-title">
													<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion1" href="#collapse6" aria-expanded="false" aria-controls="collapseThree3">
								...
								<div class="card mb-lg-0">
									...
									<div class="card-body">
										...
										<div class="pt-4">
											...
											<a href="#" class="btn btn-primary">Send Question</a>
										</div>
									</div>
								</div>
							</div>
